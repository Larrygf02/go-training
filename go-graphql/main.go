...
func populate() []Tutorial {
	author := &Author{Name: "Peque Grace", Tutorials: []int{1}}
	tutorial := Tutorial{
		Id:     1,
		Title:  "Go Grapqhl Tutorial",
		Author: *author,
		Comments: []Comment{
...
func main() {
	...
	var commentType = graphql.NewObject(
		graphql.ObjectConfig{
			Name: "Comment", Fields: graphql.Fields{
	...
	var authorType = graphql.NewObject(
		graphql.ObjectConfig{
			Name: "Author", Fields: graphql.Fields{
	...
	if err != nil {
		log.Fatal("Failed to created new Graphql Schema, err %v", err)
	}
